...
//@SpringBootTest
public class Sdi2021304SpringApplicationTests {
...
//	static String Geckdriver024 = "H:\\OneDrive\\OneDrive - Universidad de Oviedo\\Uni\\3Curso\\2ºSemestre\\Sistemas Distribuidos e Internet\\Laboratorio\\lab5\\PL-SDI-Sesión5-material\\geckodriver024win64.exe";
	...
	// TODO Te dejamos para ti en el mismo caso de test comprobar “errores” en el
	// resto de los campos.

	// Te dejamos para ti la creación del PO PO_LoginView. Inspírate en
	// PO_RegisterView.
...
//		PO_View.checkElement(driver, "text", "99999993D");
	...
	/*
	 * 
	 * Dado que este caso es un poco más complejo que los anteriores, vamos a
	 * indicar el orden de interacción y los métodos reciclados o nuevas consultas
	 * xpath empleadas:
	 * 
	 ...
	 * 
	 * 3. Esperamos que aparezca la cabecera de datos privados de profesor
	 * (PO_View.checkElement).
	 * 
	 * 4. Pinchamos la opción de menú de notas
	 * ("//li[contains(@id, 'marks-menu')]/a").
	 * 
	 * 5. Pinchamos en la opción de listado de notas
	 * ("//a[contains(@href, 'mark/list')]").
	 * 
	 * 6. Pinchamos en el tercer enlace de paginación
	 * ("//a[contains(@class, 'page-link')]").
	 * 
	 * 7. Pinchamos el enlace de borrado de la nota con descripción “Nota Nueva 1”
	 * ("//td[contains(text(), 'Nota Nueva 1')]/following-sibling:: /a[contains(@href,'mark/delete')]"
	 * ).
	 * 
	 * 8. Vamos de nuevo a la última página ya que al borrar una nota la paginación
	 * nos lleva a la página 1. ("//a[contains(@class, 'page-link')]).
	 * 
	 * 9. Comprobamos que en esa página no aparezca la descripción “Nota Nueva 1”
	 * (SeleniumUtils.EsperaCargaPaginaNoTexto).
	 * 
	 */
